...
In Crystal 1.19 a new [Sync][sync] library was added which adds several primitives to make it easier to make high preformance concurrent/parallel programs.
